...
def accelerate(lvl):
    """
    Возвращает изменени скорости при улучшении фабрики
    соответствующей переданному значению
    """
    return cost(lvl)/20
...
def img(lvl):
    """
    Возвращает изображение(его имя в img)фабрики
    соответствующей переданному значению
    """
...
def field_h(lvl, h=G.M_TOP):
    """
    Возвращет высоту для отрисовки фабрики
    соответствующей переданному значению
    """
    if lvl == 1:
        return h
